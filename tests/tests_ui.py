...
def test_code_pass(browser_setup):
    ...
    print(f"GET LIST USERS / Статус кода: {code[0]}")
...
def test_negative(browser_setup):
    ...
    print(f"GET SINGLE USER NOT FOUND / Статус кода: {code[2]}")
    ...
    print(f"GET SINGLE RESOURCE NOT FOUND / Статус кода: {code[2]}")
    ...
    print(f"DELETE / Статус кода: {code[3]}")
